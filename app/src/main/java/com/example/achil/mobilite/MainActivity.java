package com.example.achil.mobilite;
...
public class MainActivity extends AppCompatActivity {
    ...
    double[][]  ODMatrix = new double[10][10]; //initialized with zeros
    WebView myWebView;
    ...
    public int computeDestination(final View view){
        ...
        builder.setMessage("Meilleure destination pour tout le monde : " + destSpinner.getItemAtPosition(bestIndex));
